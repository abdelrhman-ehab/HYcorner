...
export default function Profile() {
  ...
  return <>
    <section className='px-2 md:px-15 mx-auto bg-transparent min-h-lvh'>
      {/* user data */}
      ...
      {/* user posts */}
      {userPosts ?
        <div className={`w-full min-w-[280px] max-w-[750px] mx-auto rounded-lg bg-gray-500/10 mt-7 flex flex-col gap-5 ${userPosts.length > 0 ? 'p-4' : 'p-0'} `}>
          {userPosts.map(post =>
        ...
        <div className='w-full min-w-[280px] max-w-[750px] mx-auto p-2 rounded-lg space-y-3 mt-7'>
